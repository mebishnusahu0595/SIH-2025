...
export function Input({ className, label, error, ...props }: InputProps) {
  const inputStyles = "flex h-12 w-full rounded-xl border-2 border-[#A7C7E7]/30 bg-white/70 backdrop-blur px-4 py-3 text-sm ring-offset-white file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-slate-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#A7C7E7] focus-visible:border-[#A7C7E7] hover:border-[#A7C7E7]/50 transition-all duration-300 disabled:cursor-not-allowed disabled:opacity-50";
