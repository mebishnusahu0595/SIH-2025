...
import { Search, MapPin, Clock, Phone, Mail, Globe, Star, Shield, Filter, MessageCircle } from "lucide-react";
...
export default function CounselorsPage() {
  ...
  const fetchCounselors = async () => {
    try {
      setLoading(true);
      const response = await fetch('http://localhost:8000/api/counselors');
